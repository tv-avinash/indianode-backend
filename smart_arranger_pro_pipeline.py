...
print("🎚 Mixing (smooth compressor only)...")

run(
    f'ffmpeg -y -i vocal.wav -i bgm.wav '
    f'-filter_complex "amix=inputs=2:weights=1 1.15,acompressor=threshold=-22dB:ratio=2:attack=20:release=250" '
